"""
Django settings for e_cross_2 project.
...
SECRET_KEY = 'django-insecure-r!=lz6kxm#cx_e$(d!8xj())@t-w4spvwlji_qy2#wp^d2-m+m'
...
WSGI_APPLICATION = 'e_cross_2.wsgi.application'
